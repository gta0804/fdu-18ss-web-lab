...
$subtotal = computeSubtotal($quantity1,$quantity2,$quantity3,$price1,$price2,$price3,$quantity4,$price4);
$shipping = computeShipping($subtotal);
$grandTotal = $subtotal+$shipping;

function computeSubtotal($quantity1,$quantity2,$quantity3,$price1,$price2,$price3,$price4,$quantity4){
    return $quantity1*$price1+$quantity2*$price2+$quantity3*$price3+$price4*$quantity4;
}
