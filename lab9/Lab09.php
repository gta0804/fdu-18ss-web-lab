...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              $country=array("Canada","Germany","Greece","Italy","United Kingdom","United States");
              foreach($country as $item)
                  echo "<a href='list.php?country=$item' role='button' class='btn btn-default'>$item</a>"
   ...
   //              </a>
			// </li>
          include_once "travel-data.inc.php";
          foreach($images as $item =>$innerImg){
              echo "<li>";
              echo "<a href='detail.php? id=$item ' class='img-responsive'></a>";
              $path=$innerImg["path"];
              $title=$innerImg["title"];
              echo "<img src='images/square/$path' alt='$title'><div class='caption'><div class='blur'></div><div class='caption-text'><h1></h1>$title</div></div>";
              echo "</li>";
          }
          ?>
